...
if($result = $conn->query($sql)):
    ...
    /*
    1. Зробити посилання на лайки (окрема сторінка, на яку ми будемо посилатися за допомогою Аякс).
    2. Зробити перевірку чи є в базі даних запис з даним постом та користувачем:
    - якщо є, лайк видалити і повертати результат, що лайк видалено
...
<div class="col-md-4">
    	<div class="blog-entry ftco-animate">
				<a href="#" class="img img-2" style="background-image: url(<?php echo $row['preview']; ?>);"></a>
	              ...
	              <p class="mb-4"><?php echo $row['discription']; ?></p>
